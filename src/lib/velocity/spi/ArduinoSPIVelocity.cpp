...
ArduinoSPIVelocity::ArduinoSPIVelocity(
...
void ArduinoSPIVelocity::begin()
{
    this->m_encoder->init();
}

AbstractVelocity::Velocity_t ArduinoSPIVelocity::getVelocity(unsigned long timePeriod)
{
...
void ArduinoSPIVelocity::getCounts()
{

    this->m_current_count = this->m_encoder->count();
}

bool ArduinoSPIVelocity::direction()
{
