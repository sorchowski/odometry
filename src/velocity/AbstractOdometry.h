#ifndef ABSTRACT_ODOMETRY_H
#define ABSTRACT_ODOMETRY_H

#define PI 3.141592653589793238462643

/*
    A generic abstract class for representing odometry readings as a measurement of wheel ticks.
